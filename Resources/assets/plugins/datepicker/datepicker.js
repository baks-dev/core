                    ...
                    return function (e) {
                        ...
                        r.addEventListener(c, (function (n) {
                            ...
                            if ("year" !== a[0]) {
                                ...
                                if (r && "year" === c) return n.header.year = n.preview.year, n.preview.setTarget = a[0], void (n.header.setTarget = a[0]);
                ...
                var ae = function (e) {
                    ...
                    if (e) {
                        ...
                        a && (a.value = l),
                            ...
                            document.getElementById(a.id)?.setAttribute('value', l ? l.toString() : '');
                    ...
                    if (r.setAttribute("data-target", o), function (e, t) {
                        var n = e.monthNavPrev, a = e.monthNavNext, r = e.yearNavPrev, c = e.yearNavNext, i = t.store,
                            ...
                            f = O(a), y = O(r), b = O(c);
                        if (y.active(), b.active(), p.active(), f.active(), "year" === m) return p.inactive(), f.inactive(), l && l.getFullYear() > h - 1 && y.inactive(), void (o && o.getFullYear() < h + 12 && b.inactive());
                    ...
                    }(e, t), "year" !== o) n.innerHTML = "<span>".concat(i[s], "</span>"), a.innerHTML = "<span>".concat(d, "</span>"); else {
                        var u = d;
                    ...
                    n.classList = "mc-calendar", n.classList.add("mc-calendar--".concat(l)), a.display.target = r[0], a.display.setDate = i || new Date, a.calendar.setDate = o, a.header.month = d, a.header.year = "year" === r[0] ? s - 4 : s, a.preview.month = d, a.preview.year = s, a.header.setTarget = r[0], a.preview.setTarget = r[0], function (e, t) {
                ...
                function fe(e, t, n) {
                    ...
                    return {
                        ...
                        setFullDate: function (e) {
                            if (!q(e).date()) throw new TypeError("Parameter of setFullDate() is not of type date");
                            D(t.calendar, {instance: this, date: e})
                        },
                        setDate: function (e) {
                            if (!q(e).number()) throw new TypeError("Parameter 'date' of setDate() is not of type number");
                            var n = this.pickedDate ? new Date(this.pickedDate) : new Date;
                            n.setDate(e), D(t.calendar, {instance: this, date: n})
                        },
                        setMonth: function (e) {
                            if (!q(e).number()) throw new TypeError("Parameter 'month' of setMonth() is not of type number");
                            var n = this.pickedDate ? new Date(this.pickedDate) : new Date;
                            n.setMonth(e), D(t.calendar, {instance: this, date: n})
                        },
                        setYear: function (e) {
                            if (!q(e).number()) throw new TypeError("Parameter 'year' of setYear() is not of type number");
                            var n = this.pickedDate ? new Date(this.pickedDate) : new Date;
