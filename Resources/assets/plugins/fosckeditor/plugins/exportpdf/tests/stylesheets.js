(function()
{
    ...
    CKEDITOR.plugins.load("exportpdf", function()
    {
        function a(a)
        {
            ...
            bender.editorBot.create({name : "editor" + Date.now(), config : e, creator : a.creator}, function(d)
            {
                var c = d.editor;
                d.setHtmlWithSelection(a.initialHtml);
                c.once("exportPdf", function(b)
                {
                ...
                c.once("exportPdf", function(b)
                {
                    ...
                    a.expectCss ? assert.isNotUndefined(b.data.css,
                        "Some CSS should be sent.") : assert.isUndefined(b.data.css, "No CSS should be sent.");
        ...
        bender.test({
            ...
            }, "test no custom stylesheets attached to divarea editor" : function()
            {
                a({
                    ...
                    expectedHtml : "\x3cdiv class\x3d\"cke_editable cke_contents_ltr\"\x3e\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e\x3c/div\x3e",
                    expectCss : !1,
                });
            }, "test one absolute path custom stylesheet attached to divarea editor" : function()
            {
                a({
                    creator : "replace",
                    initialHtml : "\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e",
                    expectedHtml : "\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"https://ckeditor.com/\"\x3e\x3cdiv class\x3d\"cke_editable cke_contents_ltr\"\x3e\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e\x3c/div\x3e",
                    expectCss : !1,
            ...
            }, "test two absolute path custom stylesheets attached to divarea editor" : function()
            {
                a({
                    creator : "replace",
                    initialHtml : "\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e",
                    expectedHtml : "\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"https://ckeditor.css/\"\x3e\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"https://cksource.css/\"\x3e\x3cdiv class\x3d\"cke_editable cke_contents_ltr\"\x3e\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e\x3c/div\x3e",
                    expectCss : !1,
                    extraConfig : {exportPdf_stylesheets : ["https://ckeditor.css", "https://cksource.css"]},
                });
            }, "test one relative path custom stylesheet attached to divarea editor" : function()
            {
                a({
                    creator : "replace",
                    initialHtml : "\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e",
                    expectedHtml : "\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"" + exportPdfUtils.toAbsoluteUrl("/css/ckeditor.css") + "\"\x3e\x3cdiv class\x3d\"cke_editable cke_contents_ltr\"\x3e\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e\x3c/div\x3e",
                    expectCss : !1,
            ...
            }, "test two relative path custom stylesheets attached to divarea editor" : function()
            {
                a({
                    ...
                    expectCss : !1,
                    extraConfig : {exportPdf_stylesheets : ["/css/ckeditor.css", "/css/cksource.css"]},
                });
            }, "test one relative and one absolute path custom stylesheets attached to divarea editor" : function()
            {
                a({
                    creator : "replace",
                    initialHtml : "\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e",
                    expectedHtml : "\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"" + exportPdfUtils.toAbsoluteUrl("/css/ckeditor.css") + "\"\x3e\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"https://ckeditor.com/\"\x3e\x3cdiv class\x3d\"cke_editable cke_contents_ltr\"\x3e\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e\x3c/div\x3e",
                    expectCss : !1,
                    extraConfig : {exportPdf_stylesheets : ["/css/ckeditor.css", "https://ckeditor.com"]},
                });
            ...
            }, "test one absolute path custom stylesheet attached to classic editor" : function()
            {
                a({
                    ...
                    expectedHtml : "\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"https://ckeditor.com/\"\x3e\x3cdiv class\x3d\"cke_editable cke_contents_ltr\"\x3e\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e\x3c/div\x3e",
                    expectCss : !1,
                    extraConfig : {removePlugins : "divarea", exportPdf_stylesheets : ["https://ckeditor.com"]},
                });
            ...
            }, "test one relative path custom stylesheet attached to classic editor" : function()
            {
                a({
                    ...
                    expectedHtml : "\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"" + exportPdfUtils.toAbsoluteUrl("/css/ckeditor.css") + "\"\x3e\x3cdiv class\x3d\"cke_editable cke_contents_ltr\"\x3e\x3cp id\x3d\"test\"\x3eHello, World!\x3c/p\x3e\x3c/div\x3e",
                    expectCss : !1,
                    extraConfig : {removePlugins : "divarea", exportPdf_stylesheets : ["/css/ckeditor.css"]},
                });
