...
}(this, (function()
{
            ...
            if(hr.keyCode == 9)
            {
                ...
                switch(text[0])
                {
                    ...
                    case "tr":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("tr", "<tr></tr>");
                        }
                        else if(text[1] == "td")
                        {
                            this.value = this.value.replace("tr.td", "<tr>\r" +
                                "<td>Значение</td>\r" +
                                "</tr>");
                        }
                        else if(text[1] == "th")
                        {
                            this.value = this.value.replace("tr.th", "<tr>\r" +
                                "<th>Колонка1</th>\r" +
                                "</tr>");
                        }
                        break;
                    ...
                    case "ul":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("ul", "<ul class=''><li>элемент</li></ul>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("ul.class", "<ul class=''><li>элемент</li></ul>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("ul.style", "<ul style=''><li>элемент</li></ul>");
                        }
                        else
                        {
                            this.value = this.value = this.value.replace("ul", "<ul class='" + text[1] + "'><li>элемент</li></ul>");
                        }
                        break;
                    ...
                    case "textarea":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("textarea", "<textarea rows='10' cols='45' name='text'></textarea>");
                        }
                        else if(text[1] === "class")
                        {
                            this.value = this.value.replace("textarea.class", "<textarea  rows='10' cols='45' name='text' class=''></textarea>");
                        }
                        else if(text[1] === "style")
                        {
                            this.value = this.value.replace("textarea.style", "<textarea rows='10' cols='45' name='text' style=''></textarea>");
                        }
                        else
                        {
                            this.value = this.value.replace("textarea." + text[1], "<textarea rows='10' cols='45' name='text' class='" + text[1] + "'></textarea>");
                        }
                        break;
                    ...
                    case "input":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("input", "<input type='button|checkbox|file|hidden|image|password|radio|reset|submit|text' name='' value=''/>");
                        }
                        else if(text[1] === "class")
                        {
                            this.value = this.value.replace("input.class", "<input type='button|checkbox|file|hidden|image|password|radio|reset|submit|text' name='' value='' class=''/>");
                        }
                        else if(text[1] === "style")
                        {
                            this.value = this.value.replace("input.style", "<input type='button|checkbox|file|hidden|image|password|radio|reset|submit|text' name='' value='' style=''/>");
                        }
                        else
                        {
                            this.value = this.value.replace("input." + text[1], "<input type='button|checkbox|file|hidden|image|password|radio|reset|submit|text' name='' value='' class='" + text[1] + "'/>");
                        }
                        break;
                    ...
                    case "btn":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("btn", "<btn></btn>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("btn.class", "<button type='submit|button|reset' class=''></button>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("btn.style", "<button type='submit|button|reset' style=''></button>");
                        }
                        else
                        {
                            this.value = this.value.replace("btn." + text[1], "<button type='submit|button|reset' class='" + text[1] + "'></button>");
                        }
                        break;
                    ...
                    case "strong":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("strong", "<strong></strong>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("strong.class", "<strong class=''></strong>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("strong.style", "<strong style=''></strong>");
                        }
                        else
                        {
                            this.value = this.value.replace("strong." + text[1], "<strong class='" + text[1] + "'></strong>");
                        }
                        break;
                    ...
                    case "a":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("a", "<a href='#' title='Title'>Ссылка</a>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("a.class", "<a href='#' title='Title' class=''>Ссылка</a>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("a.style", "<a href='#'  style=''>Ссылка</a>");
                        }
                        else
                        {
                            this.value = this.value.replace("a." + text[1], "<a href='#' title='Title' class='" + text[1] + "'>Ссылка</a>");
                        }
                        break;
                    ...
                    case "img":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("img", "<img src='#' alt='Alt' title='Title' />");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("img.class", "<img src='#' alt='Alt' title='Title' class='Class' />");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("img.style", "<img src='#' alt='Alt' title='Title' style='' />");
                        }
                        else
                        {
                            this.value = this.value.replace("img." + text[1], "<img src='#' alt='Alt' title='Title' class='" + text[1] + "' />");
                        }
                        break;
                    ...
                    case "h1":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("h1", "<h1>Заголовок1</h1>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("h1.class", "<h1 class=''>Заголовок1</h1>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("h1.style", "<h1 style=''>Заголовок1</h1>");
                        }
                        else
                        {
                            this.value = this.value.replace("h1." + text[1], "<h1 class='" + text[1] + "'>Заголовок1</h1>");
                        }
                        break;
                    ...
                    case "h2":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("h2 ", "<h2>Заголовок2</h2>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("h2.class", "<h2 class=''>Заголовок2</h2>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("h2.style", "<h2 style=''>Заголовок2</h2>");
                        }
                        else
                        {
                            this.value = this.value.replace("h2." + text[1], "<h2 class='" + text[1] + "'>Заголовок2</h2>");
                        }
                        break;
                    ...
                    case "h3":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("h3", "<h3>Заголовок3</h3>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("h3.class", "<h3 class=''>Заголовок3</h3>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("h3.style", "<h3 style=''>Заголовок3</h3>");
                        }
                        else
                        {
                            this.value = this.value.replace("h3." + text[1], "<h3 class='" + text[1] + "'>Заголовок3</h3>");
                        }
                        break;
                    ...
                    case "h4":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("h4 ", "<h4>Заголовок4</h4>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("h4.class", "<h4 class=''>Заголовок4</h4>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("h4.style", "<h4 style=''>Заголовок4</h4>");
                        }
                        else
                        {
                            this.value = this.value.replace("h4." + text[1], "<h4 class='" + text[1] + "'>Заголовок4</h4>");
                        }
                        break;
                    ...
                    case "h5":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("h5", "<h5>Заголовок5</h5>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("h5.class", "<h5 class=''>Заголовок5</h5>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("h5.style", "<h5 style=''>Заголовок5</h5>");
                        }
                        else
                        {
                            this.value = this.value.replace("h5." + text[1], "<h5 class='" + text[1] + "'>Заголовок5</h5>");
                        }
                        break;
                    ...
                    case "h6":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("h6", "<h6>Заголовок6</h6>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("h6.class", "<h6 class=''>Заголовок6</h6>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("h6.style", "<h6 style=''>Заголовок6</h6>");
                        }
                        else
                        {
                            this.value = this.value.replace("h6." + text[1], "<h6 class='" + text[1] + "'>Заголовок6</h6>");
                        }
                        break;
                    ...
                    case "p":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("p", "<p>&nbsp;</p>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("p.class", "<p class=''></p>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("p.style", "<p style=''></p>");
                        }
                        else
                        {
                            this.value = this.value.replace("p." + text[1], "<p class='" + text[1] + "'></p>");
                        }
                        break;
                    ...
                    case "span":
                        if(text[1] === undefined)
                        {
                            this.value = this.value.replace("span", "<span></span>");
                        }
                        else if(text[1] == "class")
                        {
                            this.value = this.value.replace("span.class", "<span class=''></span>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("span.style", "<span style=''></span>");
                        }
                        else
                        {
                            this.value = this.value.replace("span." + text[1], "<span class='" + text[1] + "'></span>");
                        }
                        break;
                    ...
                    case "div":
                        ...
                        {
                            this.value = this.value.replace("div.class", "<div class=''></div>");
                        }
                        else if(text[1] == "style")
                        {
                            this.value = this.value.replace("div.style", "<div style=''></div>");
                        }
                        else
                        {
                            this.value = this.value.replace("div." + text[1], "<div class='" + text[1] + "'></div>");
                        }
                        break;
                    default:
        ...
        i.prototype = {
            ...
            heightAtLine : function(hn, hr, hq)
            {
                ...
                return fz(this, ho, {
                    top : 0,
                    left : 0,
                }, hr || "page", hq || hm).top + (hm ? this.doc.height - b6(ho) : 0);
            },
    ...
    ad.prototype.init = function(hl)
    {
        ...
        ci(hm, "compositionstart", function()
        {
            ...
            hk.composing = {
                start : hp,
                range : i.markText(hp, i.getCursor("to"), {className : "CodeMirror-composing"}),
            };
        });
