...
}(function(e)
{
    ...
    function r(e, n, o)
    {
        ...
        for(var r = o.line, i = o.ch, s = e.lastLine(); r <= s; r++, i = 0)
        {
            ...
            if(l)
            {
                return {from : g(r, l.index), to : g(r, l.index + l[0].length), match : l};
            }
        }
    }
    ...
    function a(e, n, o)
    {
        ...
        for(var r = o.line, i = o.ch, a = e.firstLine(); r >= a; r--, i = -1)
        {
            ...
            if(c)
            {
                return {from : g(r, c.index), to : g(r, c.index + c[0].length), match : c};
            }
        }
    }
    ...
    function u(e, n, t, o)
    {
        ...
        e:for(var s = t.line, a = t.ch, l = e.lastLine() + 1 - i.length; s <= l; s++, a = 0)
        {
            ...
            if(f.slice(m) == i[0])
            {
                for(var v = 1; v < i.length - 1; v++) if(r(e.getLine(s + v)) != i[v])
                {
                    continue e;
                }
                var y = e.getLine(s + i.length - 1), x = r(y), C = i[i.length - 1];
                if(x.slice(0, C.length) == C)
                {
                    return {
    ...
    function f(e, n, t, o)
    {
        ...
        e:for(var s = t.line, a = t.ch, l = e.firstLine() - 1 + i.length; s >= l; s--, a = -1)
        {
            ...
            {
                for(var v = 1, t = s - i.length + 1; v < i.length - 1; v++) if(r(e.getLine(t + v)) != i[v])
                {
                    continue e;
                }
                var y = e.getLine(s + 1 - i.length), x = r(y);
                if(x.slice(x.length - i[0].length) == i[0])
                {
                    return {
    ...
    function h(e, n, o, s)
    {
        ...
        var c;
        "object" == typeof s ? c = s.caseFold : (c = s, s = null), "string" == typeof n ? (null == c && (c = !1), this.matches = function(t,
            o)
        {
    ...
    }, d = function(e)
    {
        ...
        }, find : function(n)
        {
            ...
            if(t)
            {
                return this.pos = t, this.atOccurrence = !0, this.pos.match || !0;
            }
...
}(function(e)
{
    ...
    function n(e, n)
    {
        return "string" == typeof e ? e = new RegExp(e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), n ? "gi" : "g") : e.global || (e = new RegExp(e.source, e.ignoreCase ? "gi" : "g")), {
            token : function(n)
            {
                ...
                if(t && t.index == n.pos)
                {
                    return n.pos += t[0].length || 1, "searching";
                }
    ...
    function h(n, t, r, i)
    {
        ...
        if(c instanceof RegExp && "x^" == c.source && (c = null), r && n.openDialog)
        {
            ...
            {
                e.e_stop(o), t && (t != l.queryText && (f(n, l, t), l.posFrom = l.posTo = n.getCursor()), u && (u.style.opacity = 1), p(n, o.shiftKey, function(e,
                    t)
                {
                    var o;
        ...
        {
            a(n, g(n), "Search for:", c, function(e)
            {
