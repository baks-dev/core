!function()
{
    var t = function(t)
    {
        ...
        }, e.t = function(t, n)
        {
            ...
            {
                for(var _ in t) e.d(i, _, function(e)
                {
                    return t[e];
                }.bind(null, _));
            }
    ...
    }, function(t, e, n)
    {
        ...
        function l(t, e)
        {
            for(var n, i = 0, _ = t.length; i < _; i++) if((n = t[i]) && 0 !== n.indexOf(e))
            {
                return !1;
            }
            return !0;
        ...
        }, c.prototype.handle_whitespace_and_comments = function(t, e)
        {
            ...
            {
                for(var _ = t.comments_before.next(); _;) this.handle_whitespace_and_comments(_, e), this.handle_token(_, e), _ = t.comments_before.next();
            }
            if(i)
            {
        ...
        {
            if(!e && ";" !== this._flags.last_token.text && "," !== this._flags.last_token.text && "=" !== this._flags.last_token.text && (this._flags.last_token.type !== k.OPERATOR || "--" === this._flags.last_token.text || "++" === this._flags.last_token.text))
            {
                for(var n = this._tokens.peek(); !(this._flags.mode !== T.Statement || this._flags.if_block && s(n, "else") || this._flags.do_block);) this.restore_mode();
            }
        ...
        }, c.prototype.handle_start_expr = function(t)
        {
            ...
            if("[" === t.text)
            {
                if(this._flags.last_token.type === k.WORD || ")" === this._flags.last_token.text)
                {
                    return a(this._flags.last_token, y) && (this._output.space_before_token = !0), this.print_token(t), this.set_mode(e), this.indent(), void (this._options.space_in_paren && (this._output.space_before_token = !0));
                }
            ...
            {
                if(this._flags.last_token.type === k.RESERVED)
                {
                    "for" === this._flags.last_token.text ? (this._output.space_before_token = this._options.space_before_conditional, e = T.ForInitializer) : i(this._flags.last_token.text, ["if", "while"]) ? (this._output.space_before_token = this._options.space_before_conditional, e = T.Conditional) : i(this._flags.last_word, ["await", "async"]) ? this._output.space_before_token = !0 : "import" === this._flags.last_token.text && "" === t.whitespace_before ? this._output.space_before_token = !1 : (i(this._flags.last_token.text, y) || "catch" === this._flags.last_token.text) && (this._output.space_before_token = !0);
                }
                else if(this._flags.last_token.type === k.EQUALS || this._flags.last_token.type === k.OPERATOR)
                {
                    this.start_of_object_property() || this.allow_wrap_or_preserved_newline(t);
                }
                else if(this._flags.last_token.type === k.WORD)
                {
        ...
        {
            if(t.type === k.RESERVED)
            {
                if(i(t.text, ["set", "get"]) && this._flags.mode !== T.ObjectLiteral)
                {
                    t.type = k.WORD;
                }
                ...
                else if(this._flags.mode === T.ObjectLiteral)
                {
            ...
            if(this.start_of_statement(t) ? a(this._flags.last_token, ["var", "let", "const"]) && t.type === k.WORD && (this._flags.declaration_statement = !0) : !t.newlines || p(this._flags.mode) || this._flags.last_token.type === k.OPERATOR && "--" !== this._flags.last_token.text && "++" !== this._flags.last_token.text || this._flags.last_token.type === k.EQUALS || !this._options.preserve_newlines && a(this._flags.last_token, ["var", "let", "const", "set", "get"]) ? this.handle_whitespace_and_comments(t) : (this.handle_whitespace_and_comments(t), this.print_newline()), this._flags.do_block && !this._flags.do_while)
            {
                if(s(t, "while"))
                {
                    return this._output.space_before_token = !0, this.print_token(t), this._output.space_before_token = !0, void (this._flags.do_while = !0);
                }
                this.print_newline(), this._flags.do_block = !1;
            }
            if(this._flags.if_block)
            {
                if(!this._flags.else_block && s(t, "else"))
                {
            ...
            {
                "NEWLINE" === n ? a(this._flags.last_token, x) ? this._output.space_before_token = !0 : "declare" === this._flags.last_token.text && a(t, ["var", "let", "const"]) ? this._output.space_before_token = !0 : this._flags.last_token.type !== k.END_EXPR ? this._flags.last_token.type === k.START_EXPR && a(t, ["var", "let", "const"]) || ":" === this._flags.last_token.text || (s(t, "if") && s(t.previous, "else") ? this._output.space_before_token = !0 : this.print_newline()) : a(t, y) && ")" !== this._flags.last_token.text && this.print_newline() : this._flags.multiline_frame && o(this._flags.mode) && "," === this._flags.last_token.text && "}" === this._last_last_text ? this.print_newline() : "SPACE" === n && (this._output.space_before_token = !0);
            }
        ...
        }, c.prototype.handle_operator = function(t)
        {
            ...
            if(a(this._flags.last_token, x))
            {
                return this._output.space_before_token = !0, void this.print_token(t);
            }
            if("*" === t.text && this._flags.last_token.type === k.DOT)
            {
            ...
            if(this._flags.last_token.type === k.OPERATOR && i(this._options.operator_position, O) && this.allow_wrap_or_preserved_newline(t), ":" === t.text && this._flags.in_case)
            {
                return this.print_token(t), this._flags.in_case = !1, this._flags.case_body = !0, void (this._tokens.peek().type !== k.START_BLOCK ? (this.indent(), this.print_newline()) : this._output.space_before_token = !0);
            }
            var s = !0, u = !0, r = !1;
            ...
            {
                "..." === t.text ? (this.allow_wrap_or_preserved_newline(t), s = this._flags.last_token.type === k.START_BLOCK, u = !1) : (i(t.text, ["--", "++", "!", "~"]) || n) && (this._flags.last_token.type !== k.COMMA && this._flags.last_token.type !== k.START_EXPR || this.allow_wrap_or_preserved_newline(t), s = !1, u = !1, !t.newlines || "--" !== t.text && "++" !== t.text || this.print_newline(!1, !0), ";" === this._flags.last_token.text && p(this._flags.mode) && (s = !0), this._flags.last_token.type === k.RESERVED ? s = !0 : this._flags.last_token.type === k.END_EXPR ? s = !("]" === this._flags.last_token.text && ("--" === t.text || "++" === t.text)) : this._flags.last_token.type === k.OPERATOR && (s = i(t.text, ["--", "-", "++", "+"]) && i(this._flags.last_token.text, ["--", "-", "++", "+"]), i(t.text, ["+", "-"]) && i(this._flags.last_token.text, ["--", "++"]) && (u = !0)), (this._flags.mode !== T.BlockStatement || this._flags.inline_frame) && this._flags.mode !== T.Statement || "{" !== this._flags.last_token.text && ";" !== this._flags.last_token.text || this.print_newline());
            }
    ...
    }, function(t, e, n)
    {
        ...
        {
            for(var e = this.__items.length - 1; e >= 0; e--) if(this.__items[e].match(t))
            {
                return !0;
            }
            return !1;
    ...
    }, function(t, e, n)
    {
        ...
        function _(t)
        {
            for(var e = "", n = 0, i = new s(t), _ = null; i.hasNext();) if(_ = i.match(/([\s]|[^\\]|\\\\)+/g), _ && (e += _[0]), "\\" === i.peek())
            {
                ...
                if((n = parseInt(_[1], 16)) > 126 && n <= 255 && 0 === _[0].indexOf("x"))
                {
                    return t;
                }
                if(n >= 0 && n < 32)
        ...
        }, E.prototype._read_punctuation = function()
        {
            ...
            if("" !== t)
            {
                return "=" === t ? this._create_token(l.EQUALS, t) : "?." === t ? this._create_token(l.DOT, t) : this._create_token(l.OPERATOR, t);
            }
        }, E.prototype._read_non_javascript = function(t)
        {
            ...
            else if(y && "-" === t && (e = this.__patterns.html_comment_end.read()))
            {
                return y = !1, this._create_token(l.COMMENT, e);
            }
            return null;
        }, E.prototype._read_comment = function(t)
        {
            ...
            if("/" === t)
            {
                ...
                {
                    "/" === this._input.peek(1) && (n = this.__patterns.comment.read(), e = this._create_token(l.COMMENT, n));
                }
            }
            return e;
        ...
        }, E.prototype._read_xml = function(t, e)
        {
            if(this._options.e4x && "<" === t && this._allow_regexp_or_xml(e))
            {
                ...
                if(i)
                {
                    ...
                    {
                        var u = !!i[1], r = i[2];
                        if(!(!!i[i.length - 1] || "![CDATA[" === r.slice(0, 8)) && (r === _ || s && r.replace(/^{\s+/, "{").replace(/\s+}$/, "}")) && (u ? --a : ++a), n += i[0], a <= 0)
                        {
                            break;
                        }
    ...
    }, function(t, e, n)
    {
        ...
        }, i.prototype._read_template = function()
        {
            ...
            {
                "{" === e && (this._disabled.handlebars || this._excluded.handlebars || (t = t || this.__patterns.handlebars_comment.read(), t = t || this.__patterns.handlebars_unescaped.read(), t = t || this.__patterns.handlebars.read()), this._disabled.django || (this._excluded.django || this._excluded.handlebars || (t = t || this.__patterns.django_value.read()), this._excluded.django || (t = t || this.__patterns.django_comment.read(), t = t || this.__patterns.django.read())));
            }
            return t;
...
}(), function()
{
    ...
    }, function(t, e, n)
    {
        ...
        }, a.prototype._handle_inside_tag = function(t, e, n, i)
        {
            ...
            if(t.set_space_before_token(e.newlines || "" !== e.whitespace_before, !0), n.is_unformatted)
            {
                t.add_raw_token(e);
            }
            else if("{" === n.tag_start_char && e.type === p.TEXT)
            {
        ...
        }, a.prototype._print_custom_beatifier_text = function(t, e, n)
        {
            ...
            if("" !== e.text)
            {
                ...
                "javascript" === n.custom_beautifier_name && "function" == typeof this._js_beautify ? _ = this._js_beautify : "css" === n.custom_beautifier_name && "function" == typeof this._css_beautify ? _ = this._css_beautify : "html" === n.custom_beautifier_name && (_ = function(t,
                    e)
                {
        ...
        a.prototype._do_optional_end_element = function(t)
        {
            ...
            if(!t.is_empty_element && t.is_start_tag && t.parent)
            {
                ...
                {
                    e = e || this._tag_stack.try_pop("dt", ["dl"]), e = e || this._tag_stack.try_pop("dd", ["dl"]);
                }
                else if("p" === t.parent.tag_name && -1 !== b.indexOf(t.tag_name))
                {
    ...
    }, function(t, e, n)
    {
        ...
        }, p.prototype._read_attribute = function(t, e, n)
        {
            ...
            if(n && "<" === n.text[0])
            {
                if("=" === t)
                {
                    i = this._create_token(r.EQUALS, this._input.next());
                }
                else if("\"" === t || "'" === t)
                {
                ...
                {
                    (_ = this.__patterns.attribute.read()) && (i = e.type === r.EQUALS ? this._create_token(r.VALUE, _) : this._create_token(r.ATTRIBUTE, _));
                }
            }
            return i;
        ...
        }, p.prototype._read_raw_content = function(t, e, n)
        {
            ...
            else if(e.type === r.TAG_CLOSE && "<" === e.opened.text[0] && "/" !== e.text[0])
            {
        ...
        {
            var e = "";
            if(this._options.unformatted_content_delimiter && t === this._options.unformatted_content_delimiter[0] && (e = this.__patterns.unformatted_content_delimiter.read()), e || (e = this.__patterns.word.read()), e)
            {
                return this._create_token(r.TEXT, e);
            }
        }, t.exports.Tokenizer = p, t.exports.TOKEN = r;
    }]), e = t;
    if("function" == typeof define && define.amd)
    {
        define("beautify-html.js", ["require", "./beautify", "./beautify-css"], function(t)
        {
    ...
    {
        "undefined" != typeof window ? window.html_beautify = function(t, n)
        {
