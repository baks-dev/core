...
}(function(e)
{
    ...
    function i(e, t)
    {
        ...
        {
            if(!t.hasOwnProperty(r) || !i(e[r], t[r]))
            {
                return !1;
            }
            n++;
    ...
    function l(t, r, o, a)
    {
        ...
        if(o.persistent)
        {
            for(var d = r.persistentStates; d && !l; d = d.next) (o.spec ? i(o.spec, d.spec) : o.mode == d.mode) && (l = d);
        }
    ...
    function s(t, n)
    {
        return function(r, o, a)
        {
            ...
            {
                return r.local.mode.indent(r.localState, o, a);
            }
            if(null == r.indent || r.local || n.dontIndentStates && d(r.state, n.dontIndentStates) > -1)
            {
                return e.Pass;
            }
    ...
    }, e.simpleMode = function(n, r)
    {
        t(r, "start");
        var i = {}, l = r.meta || {}, d = !1;
        for(var c in r) if(c != l && r.hasOwnProperty(c))
        {
            for(var u = i[c] = [], f = r[c], m = 0; m < f.length; m++)
            {
                var p = f[m];
        ...
        if(l)
        {
            for(var h in l) l.hasOwnProperty(h) && (g[h] = l[h]);
        }
        return g;
    };
}), function(e)
        ...
        return {
            ...
            }, token : function(o, a)
            {
                if(a.innerActive)
                {
                    ...
                    if(!i.close && o.sol())
                    {
                        return a.innerActive = a.inner = null, this.token(o, a);
                    }
                    var d = i.close ? n(l, i.close, o.pos, i.parseDelimiters) : -1;
                    if(d == o.pos && !i.parseDelimiters)
                    {
                        return o.match(i.close), a.innerActive = a.inner = null, i.delimStyle && i.delimStyle + " " + i.delimStyle + "-close";
                    }
...
}(function(e)
{
    ...
    e.defineMode("xml", function(r, o)
    {
        function a(e, t)
        {
            ...
            if("<" == r)
            {
                return e.eat("!") ? e.eat("[") ? e.match("CDATA[") ? n(d("atom", "]]>")) : null : e.match("--") ? n(d("comment", "--\x3e")) : e.match("DOCTYPE", !0, !0) ? (e.eatWhile(/[\w\._\-]/), n(s(1))) : null : e.eat("?") ? (e.eatWhile(/[\w\._\-]/), t.tokenize = d("meta", "?>"), "meta") : (C = e.eat("/") ? "closeTag" : "openTag", t.tokenize = i, "tag bracket");
            }
            if("&" == r)
            {
                var o;
        ...
        function i(e, t)
        {
            ...
            if(">" == n || "/" == n && e.eat(">"))
            {
                return t.tokenize = a, C = ">" == n ? "endTag" : "selfcloseTag", "tag bracket";
            }
            if("=" == n)
            {
        ...
        function f(e, t)
        {
            for(var n; ;)
            {
                ...
                if(n = e.context.tagName, !w.contextGrabbers.hasOwnProperty(n) || !w.contextGrabbers[n].hasOwnProperty(t))
                {
                    return;
                }
                u(e);
        ...
        return a.isInText = !0, {
            ...
            indent : function(t, n, r)
            {
                ...
                {
                    return t.tagStart == t.indented ? t.stringStartCol + 1 : t.indented + S;
                }
                if(o && o.noIndent)
                {
                    return e.Pass;
                }
                if(t.tokenize != i && t.tokenize != a)
                {
                    return r ? r.match(/^(\s*)/)[0].length : 0;
                }
                if(t.tagName)
                {
                    return !1 !== w.multilineTagIndentPastTag ? t.tagStart + t.tagName.length + 2 : t.tagStart + S * (w.multilineTagIndentFactor || 1);
                }
                if(w.alignCDATA && /<!\[CDATA\[/.test(n))
                {
                    return 0;
                }
                var l = n && /^<(\/)?([\w_:\.-]*)/.exec(n);
                if(l && l[1])
                {
                    for(; o;)
                    {
                        ...
                        if(!w.implicitlyClosed.hasOwnProperty(o.tagName))
                        {
                            break;
                        }
                        o = o.prev;
