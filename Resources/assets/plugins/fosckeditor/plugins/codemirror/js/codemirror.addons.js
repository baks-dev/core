...
}(function(e)
{
    function t(t)
    {
        ...
        {
            var c = a[s].head;
            if(!/\bcomment\b/.test(t.getTokenTypeAt(c)))
            {
                return e.Pass;
            }
            var d = t.getModeAt(c);
            ...
            if(p && i.blockCommentContinue)
            {
                ...
                else if(c.ch >= p.length && (f = u.lastIndexOf(p, c.ch - p.length)) > -1 && f > g)
                {
                    if(n(0, u) >= f)
                    {
                        h = u.slice(0, f);
                ...
                {
                    (f = u.indexOf(i.blockCommentContinue)) > -1 && f <= c.ch && f <= n(0, u) && (h = u.slice(0, f));
                }
                null != h && (h += i.blockCommentContinue);
            }
            if(null == h && m && r(t))
            {
                if(null == u && (u = t.getLine(c.line)), f = u.indexOf(m), c.ch || f)
                {
                    if(f > -1 && n(0, u) >= f)
                    {
                        if(!(h = n(c.ch, u) > -1))
    ...
    function c(n, r)
    {
        ...
        for(var d, f = t(o, "closeBefore"), p = t(o, "triples"), m = a.charAt(c + 1) == r, g = n.listSelections(), v = c % 2 == 0, b = 0; b < g.length; b++)
        {
            ...
            else if(!m && v || w != r)
            {
                ...
                {
                    if(x.ch > 2 && /\bstring/.test(n.getTokenTypeAt(h(x.line, x.ch - 2))))
                    {
                        return e.Pass;
                    }
                    y = "addFour";
                ...
                else if(m)
                {
                    ...
                    if(e.isWordChar(w) || C == r || e.isWordChar(C))
                    {
                        return e.Pass;
                    }
                    y = "both";
                ...
                {
                    if(!v || !(0 === w.length || /\s/.test(w) || f.indexOf(w) > -1))
                    {
                        return e.Pass;
                    }
                    y = "both";
            ...
            {
                y = m && u(n, x) ? "both" : p.indexOf(r) >= 0 && n.getRange(x, h(x.line, x.ch + 3)) == r + r + r ? "skipThree" : "skip";
            }
            if(d)
            {
                if(d != y)
        ...
        n.operation(function()
        {
            ...
            {
                "both" == d ? (n.replaceSelection(O + A, null), n.triggerElectric(O + A), l(n, -1)) : "addFour" == d && (n.replaceSelection(O + O + O + O, "before"), l(n, 1));
            }
        });
    }
        ...
        for(var n = []; ;)
        {
            ...
            if("selfClose" != r)
            {
                if(i[1])
                {
                    ...
                    if(c < 0 && (!t || t == i[2]))
                    {
                        return {tag : i[2], from : f(o, l), to : f(e.line, e.ch)};
                    }
                }
                else
                {
        ...
        for(var n = []; ;)
        {
            ...
            if("selfClose" != r)
            {
                ...
                else
                {
                    ...
                    if(s < 0 && (!t || t == a[2]))
                    {
                        return {tag : a[2], from : f(e.line, e.ch), to : f(i, o)};
                    }
                }
            }
            else
...
}(function(e)
{
    function t(t)
    {
        ...
        for(var n = t.listSelections(), r = [], s = t.getOption("autoCloseTags"), c = 0; c < n.length; c++)
        {
            ...
            var y = m.toLowerCase();
            if(!m || "string" == u.type && (u.end != d.ch || !/[\"\']/.test(u.string.charAt(u.string.length - 1)) || 1 == u.string.length) || "tag" == u.type && p.close || u.string.indexOf("/") == d.ch - u.start - 1 || v && i(v, y) > -1 || o(t, f.mode.xmlCurrentContext && f.mode.xmlCurrentContext(h) || [], m, d, !0))
            {
                return e.Pass;
            }
            ...
            if(k && i(k, m) > -1)
            {
                r[c] = {text : "/>", newPos : e.Pos(d.line, d.ch + 2)};
            }
            else
            {
                var x = b && i(b, y) > -1;
    ...
    function n(t, n)
    {
        for(var r = t.listSelections(), i = [], a = n ? "/" : "</", l = t.getOption("autoCloseTags"), s = "object" == typeof l && l.dontIndentOnSlash, c = 0; c < r.length; c++)
        {
            ...
            if(n && ("string" == u.type || "<" != u.string.charAt(0) || u.start != d.ch - 1))
            {
                return e.Pass;
            }
            var p, m = "xml" != f.mode.name && "htmlmixed" == t.getMode().name;
            if(m && "javascript" == f.mode.name)
            {
                p = a + "script";
            }
            else if(m && "css" == f.mode.name)
            {
                p = a + "style";
            }
            else
...
}(function(e)
{
    ...
    function t(t, i, o, a)
    {
        ...
        {
            var s = r(t, o, "rangeFinder");
        }
        "number" == typeof i && (i = e.Pos(i, 0));
        var c = r(t, o, "minFoldSize"), d = l(!0);
        if(r(t, o, "scanUp"))
        {
            for(; !d && i.line > t.firstLine();) i = e.Pos(i.line - 1, 0), d = l(!1);
        }
    ...
    {
        for(var t = this.findMarksAt(e), n = 0; n < t.length; ++n) if(t[n].__isFold)
        {
            return !0;
        }
    ...
    e.registerHelper("fold", "brace", function(t, n)
    {
        function r(r)
        {
            for(var l = n.ch, s = 0; ;)
            {
                ...
                if(-1 != c)
                {
                    ...
                    if(i = t.getTokenTypeAt(e.Pos(o, c + 1)), !/^(comment|string)/.test(i))
                    {
                        return c + 1;
                    }
                    l = c - 1;
        ...
        if(null == c && (l = "[", s = "]", c = r("[")), null != c)
        {
            ...
            e:for(var p = o; p <= h; ++p) for(var m = t.getLine(p), g = p == o ? c : 0; ;)
            {
                ...
                if(v < 0 && (v = m.length), b < 0 && (b = m.length), (g = Math.min(v, b)) == m.length)
                {
                    break;
                }
            ...
            if(null != d && o != d)
            {
                return {from : e.Pos(o, c), to : e.Pos(d, u)};
            }
        }
    }), e.registerHelper("fold", "import", function(t, n)
    {
        function r(n)
        {
            ...
            for(var i = n, o = Math.min(t.lastLine(), n + 10); i <= o; ++i)
            {
                ...
                if(-1 != l)
                {
                    return {startCh : r.end, end : e.Pos(i, l)};
                }
            }
        }

        var i, o = n.line, a = r(o);
        if(!a || r(o - 1) || (i = r(o - 2)) && i.end.line == o - 1)
        {
            return null;
        }
        for(var l = a.end; ;)
    ...
    }, function(t, n)
    {
        ...
        if(i && o)
        {
            ...
            e:for(var g = l; g <= m; ++g) for(var v = t.getLine(g), b = g == l ? a : 0; ;)
            {
                ...
                if(y < 0 && (y = v.length), k < 0 && (k = v.length), (b = Math.min(y, k)) == v.length)
                {
                    break;
                }
                if(b == y)
            ...
            if(null != f && (l != f || h != a))
            {
                return {from : e.Pos(l, a), to : e.Pos(f, h)};
            }
        }
    });
}), function(e)
...
}(function(e)
{
    ...
    function a(t, n)
    {
        ...
        }), H.bottom - P > 0)
        {
            ...
            if(k.top - (k.bottom - H.top) - E > 0)
            {
                f.style.top = (w = k.top - E - A) + "px", C = !1;
            }
            else if(E > P)
            {
        ...
        var B = H.right - L;
        if(B > 0 && (H.right - H.left > L && (f.style.width = L - 5 + "px", B -= H.right - H.left - L), f.style.left = (x = k.left - B - O) + "px"), z)
        {
            for(var I = f.firstChild; I; I = I.nextSibling) I.style.paddingRight = l.display.nativeBarWidth + "px";
        }
        ...
        l.on("scroll", this.onScroll = function()
        {
            ...
            if(C || (i += f.offsetHeight), i <= n.top || i >= n.bottom)
            {
                return t.close();
            }
    ...
    }, e.defineExtension("showHint", function(r)
    {
        ...
        if(!(i.length > 1))
        {
            ...
            {
                if(!r.hint.supportsSelection)
                {
                    return;
                }
                for(var o = 0; o < i.length; o++) if(i[o].head.line != i[o].anchor.line)
                {
                    return;
                }
            }
    ...
    t.prototype = {
        ...
        }, cursorActivity : function()
        {
            ...
            if(t.line != this.startPos.line || n.length - t.ch != this.startLen - this.startPos.ch || t.ch < e.ch || this.cm.somethingSelected() || !t.ch || this.options.closeCharacters.test(n.charAt(t.ch - 1)))
            {
                this.options.closeOnCursorActivity && this.close();
            }
            else
            {
                var r = this;
...
}(function(e)
{
    ...
    function r(t, n, r, i)
    {
        ...
        if(!/\b(?:string|comment)\b/.test(a.type))
        {
            ...
            if("json" !== l.mode.helperType)
            {
                ...
                {
                    if(d = r(t, c(o.line, d.start)), "." != d.string)
                    {
                        return;
                    }
                    if(d = r(t, c(o.line, d.start)), !u)
                    {
                        var u = [];
                    }
                    u.push(d);
    ...
    function s(e, r, i, o)
    {
        ...
        else
        {
            ...
            {
                for(var y in o.additionalContext) a(y);
            }
...
}(function(e)
{
    ...
    e.defineMode("css", function(t, n)
    {
        ...
        return F.top = function(e, t, n)
        {
            ...
            if(L && /@component/i.test(e))
            {
                return s(n, t, "atComponentBlock");
            }
            if(/^@(-moz-)?document$/i.test(e))
            {
                return s(n, t, "documentTypes");
            }
            if(/^@(media|supports|(-moz-)?document|import)$/i.test(e))
            {
                return s(n, t, "atBlock");
            }
    ...
    function n(n, i)
    {
        ...
        if(a)
        {
            ...
            if(u.mode.xmlCurrentTag)
            {
                ...
                {
                    g && "<" == d.string ? y = "open" : g && "</" == d.string && (y = "close");
                }
                ...
                if(!g && !k || y)
                {
                    ...
                    if(C && "close" != y)
                    {
                        for(var O = 0; O < C.length; ++O) f && !t(C[O], f, s) || p.push("<" + C[O]);
                    }
                    else if("close" != y)
                    {
                        for(var A in a) !a.hasOwnProperty(A) || "!top" == A || "!attrs" == A || f && !t(A, f, s) || p.push("<" + A);
                    }
                ...
                else
                {
                    ...
                    if("string" == d.type || "=" == d.string)
                    {
                        var L,
                            ...
                            P = b.match(/([^\s\u00a0=<>\"\']+)=$/);
                        if(!P || !j.hasOwnProperty(P[1]) || !(L = j[P[1]]))
                        {
                            return;
                        }
                        ...
                        var E = function(e)
                        {
                            if(e)
                            {
                                for(var n = 0; n < e.length; ++n) f && !t(e[n], f, s) || p.push(l + e[n] + l);
                            }
                            return o();
                        };
...
}(function(e)
{
    ...
    e.extendMode("xml", {
        ...
        newlineAfterToken : function(e, t, n, r)
        {
            ...
            if(this.isXML = "xml" == this.configuration, "comment" == e || /<!--/.test(n))
            {
                return !1;
            }
            if("tag" == e)
            {
                ...
                if(0 == t.indexOf("</") && (this.tagType = "close", l = t.match(/^<\/\s*?([\w]+?)$/i), null != l && (s = l[1].toLowerCase()), -1 != ("|" + i + "|").indexOf("|" + s + "|") && (this.noBreak = !0)), 0 == t.indexOf(">") && "close" == this.tagType)
                {
                    return this.tagType = "", 0 == n.indexOf("<") && (l = n.match(/^<\/?\s*?([\w]+?)(\s|>)/i), s = null != l ? l[1].toLowerCase() : "", -1 == ("|" + o + "|").indexOf("|" + s + "|")) ? (this.noBreak = !1, !0) : (a = this.noBreak, this.noBreak = !1, !a);
                }
            }
    ...
    }), e.defineExtension("commentRange", function(t, n, r)
    {
        ...
        i.operation(function()
        {
            if(t)
            {
                i.replaceRange(o.commentEnd, r), i.replaceRange(o.commentStart, n), i.setSelection(n, {
                    line : r.line,
                    ch : r.ch + o.commentStart.length + o.commentEnd.length,
                }), n.line == r.line && n.ch == r.ch && i.setCursor(n.line, n.ch + o.commentStart.length);
            }
            else
            {
...
}(function(e)
{
    ...
    function i(e, t, r)
    {
        ...
        for(var i = r.line, o = r.ch, a = e.lastLine(); i <= a; i++, o = 0)
        {
            ...
            if(s)
            {
                return {from : m(i, s.index), to : m(i, s.index + s[0].length), match : s};
            }
        }
    }
    ...
    function l(e, t, r)
    {
        ...
        for(var i = r.line, o = r.ch, l = e.firstLine(); i >= l; i--, o = -1)
        {
            ...
            if(c)
            {
                return {from : m(i, c.index), to : m(i, c.index + c[0].length), match : c};
            }
        }
    }
    ...
    function d(e, t, n, r)
    {
        ...
        e:for(var a = n.line, l = n.ch, s = e.lastLine() + 1 - o.length; a <= s; a++, l = 0)
        {
            ...
            if(u.slice(g) == o[0])
            {
                for(var v = 1; v < o.length - 1; v++) if(i(e.getLine(a + v)) != o[v])
                {
                    continue e;
                }
    ...
    function u(e, t, n, r)
    {
        ...
        e:for(var a = n.line, l = n.ch, s = e.firstLine() - 1 + o.length; a >= s; a--, l = -1)
        {
            ...
            {
                for(var v = 1, n = a - o.length + 1; v < o.length - 1; v++) if(i(e.getLine(n + v)) != o[v])
                {
                    continue e;
                }
                var b = e.getLine(a + 1 - o.length), y = i(b);
                if(y.slice(y.length - o[0].length) == o[0])
                {
                    return {
    ...
    function f(e, t, r, a)
    {
        ...
        var c;
        "object" == typeof a ? c = a.caseFold : (c = a, a = null), "string" == typeof t ? (null == c && (c = !1), this.matches = function(n,
            r)
        {
    ...
    t.prototype.findMatches = function()
    {
        if(this.gap)
        {
            ...
            }), i = this.options && this.options.maxMatches || 1e3; r.findNext();)
            {
                ...
                if(this.matches.splice(t++, 0, n), this.matches.length > i)
                {
                    break;
                }
            }
        ...
        return {
            ...
            }, token : function(i, o)
            {
                if(o.innerActive)
                {
                    ...
                    {
                        return i.match(a.close), o.innerActive = o.inner = null, a.delimStyle && a.delimStyle + " " + a.delimStyle + "-close";
                    }
