...
}(function(e)
{
    ...
    e.defineMode("xml", function(n, o)
    {
        function i(e, t)
        {
            ...
            if("<" == n)
            {
                return e.eat("!") ? e.eat("[") ? e.match("CDATA[") ? r(s("atom", "]]>")) : null : e.match("--") ? r(s("comment", "--\x3e")) : e.match("DOCTYPE", !0, !0) ? (e.eatWhile(/[\w\._\-]/), r(c(1))) : null : e.eat("?") ? (e.eatWhile(/[\w\._\-]/), t.tokenize = s("meta", "?>"), "meta") : (S = e.eat("/") ? "closeTag" : "openTag", t.tokenize = a, "tag bracket");
            }
            if("&" == n)
            {
                var o;
        ...
        function a(e, t)
        {
            ...
            if(">" == r || "/" == r && e.eat(">"))
            {
                return t.tokenize = i, S = ">" == r ? "endTag" : "selfcloseTag", "tag bracket";
            }
            if("=" == r)
            {
        ...
        function p(e, t)
        {
            for(var r; ;)
            {
                ...
                if(r = e.context.tagName, !z.contextGrabbers.hasOwnProperty(r) || !z.contextGrabbers[r].hasOwnProperty(t))
                {
                    return;
                }
                u(e);
        ...
        return i.isInText = !0, {
            ...
            indent : function(t, r, n)
            {
                ...
                if(t.tokenize != a && t.tokenize != i)
                {
                    return n ? n.match(/^(\s*)/)[0].length : 0;
                }
                if(t.tagName)
                {
                    return !1 !== z.multilineTagIndentPastTag ? t.tagStart + t.tagName.length + 2 : t.tagStart + x * (z.multilineTagIndentFactor || 1);
                }
                if(z.alignCDATA && /<!\[CDATA\[/.test(r))
                {
                    return 0;
                }
                var l = r && /^<(\/)?([\w_:\.-]*)/.exec(r);
                if(l && l[1])
                {
                    for(; o;)
                    {
                        ...
                        if(!z.implicitlyClosed.hasOwnProperty(o.tagName))
                        {
                            break;
                        }
                        o = o.prev;
...
}(function(e)
{
    ...
    e.defineMode("javascript", function(t, r)
    {
        ...
        function i(e, t)
        {
            ...
            if(/\d/.test(r))
            {
                return e.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), o("number", "number");
            }
            if("/" == r)
            {
                return e.eat("*") ? (t.tokenize = l, l(e, t)) : e.eat("/") ? (e.skipToEnd(), o("comment", "comment")) : Be(e, t, 1) ? (n(e), e.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), o("regexp", "string-2")) : (e.eat("="), o("operator", "operator", e.current()));
            }
            if("`" == r)
            {
                return t.tokenize = s, s(e, t);
            }
            if("#" == r && "!" == e.peek())
            {
                return e.skipToEnd(), o("meta", "meta");
            }
            if("#" == r && e.eatWhile(Ye))
            {
                return o("variable", "property");
            }
            if("<" == r && e.match("!--") || "-" == r && e.match("->") && !/\S/.test(e.string.slice(0, e.start)))
            {
                return e.skipToEnd(), o("comment", "comment");
            }
            if(Xe.test(r))
            {
                return ">" == r && t.lexical && ">" == t.lexical.type || (e.eat("=") ? "!" != r && "=" != r || e.eat("=") : /[<>*+\-|&?]/.test(r) && (e.eat(r), ">" == r && e.eat(r))), "?" == r && e.eat(".") ? o(".") : o("operator", "operator", e.current());
            }
            if(Ye.test(r))
            {
                e.eatWhile(Ye);
        ...
        function a(e)
        {
            ...
            {
                var n, a = !1;
                if(Ue && "@" == t.peek() && t.match(Ze))
                {
                    return r.tokenize = i, o("jsonld-keyword", "meta");
                }
        ...
        function u(e, t)
        {
            for(var r = e.localVars; r; r = r.next) if(r.name == t)
            {
                return !0;
            }
            for(var n = e.context; n; n = n.prev) for(var r = n.vars; r; r = r.next) if(r.name == t)
            {
                return !0;
            }
        }
        ...
        function g(e, t)
        {
            for(var r = t; r; r = r.next) if(r.name == e)
            {
                return !0;
            }
            return !1;
        ...
        function h(e)
        {
            ...
            if(et.marked = "def", t.context)
            {
                if("var" == t.lexical.info && t.context && t.context.block)
                {
                    ...
                    if(null != n)
                    {
                        return void (t.context = n);
                    }
                }
                else if(!g(e, t.localVars))
                {
                    return void (t.localVars = new v(e, t.localVars));
                }
            }
        ...
        function K(e)
        {
            if("}" == e)
            {
                return et.marked = "string-2", et.state.tokenize = s, f(_);
            }
        }
        ...
        function U(e, t)
        {
            if("async" == e)
            {
                return et.marked = "property", f(U);
            }
            if("variable" == e || "keyword" == et.style)
            {
                if(et.marked = "property", "get" == t || "set" == t)
                {
                    return f(H);
                }
                var r;
        ...
        function Q(e)
        {
            if(Ge && ":" == e)
            {
                return et.stream.match(/^\s*\w+\s+is\b/, !1) ? f(C, ee, te) : f(te);
            }
        }
        ...
        return z.lex = !0, j.lex = !0, {
            ...
            token : function(e, t)
            {
                if(e.sol() && (t.lexical.hasOwnProperty("align") || (t.lexical.align = !1), t.indented = e.indentation(), c(e, t)), t.tokenize != l && e.eatSpace())
                {
                    return null;
                }
                var r = t.tokenize(e, t);
...
}(function(e)
{
    ...
    e.defineMode("htmlmixed", function(r, n)
    {
        function s(n, i)
        {
            ...
            if(p && !/[<>\s\/]/.test(n.current()) && (l = i.htmlState.tagName && i.htmlState.tagName.toLowerCase()) && d.hasOwnProperty(l))
            {
                i.inTag = l + " ";
            }
            else if(i.inTag && p && />$/.test(n.current()))
            {
            ...
            {
                i.inTag && (i.inTag += n.current(), n.eol() && (i.inTag += " "));
            }
            return u;
        }
        ...
        if(i(l, d), u && i(u, d), p)
        {
            for(var m = p.length - 1; m >= 0; m--) d.script.unshift(["type", p[m].matches, p[m].mode]);
        }
        return {
            startState : function()
            {
        ...
        return {
            ...
            }, token : function(o, i)
            {
                if(i.innerActive)
                {
                    ...
                    if(!a.close && o.sol())
                    {
                        return i.innerActive = i.inner = null, this.token(o, i);
                    }
                    var s = a.close ? r(l, a.close, o.pos, a.parseDelimiters) : -1;
                    if(s == o.pos && !a.parseDelimiters)
                    {
                        return o.match(a.close), i.innerActive = i.inner = null, a.delimStyle && a.delimStyle + " " + a.delimStyle + "-close";
                    }
