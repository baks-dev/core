    ...
    q = CKEDITOR.tools.addFunction(function(c)
    {
        ...
        switch(a)
        {
            ...
            case r ? 37 : 39:
                ...
                {
                    a = a.getChild(0), 1 == a.type ? (a.focus(), d(null, b), e(null, a), c.preventDefault(!0)) : d(null, b);
                }
                else if(a = b.getParent().getParent().getNext())
                {
                    (a = a.getChild([0, 0])) && 1 == a.type ? (a.focus(), d(null, b), e(null, a), c.preventDefault(!0)) : d(null, b);
                }
                break;
            case r ? 39 : 37:
