...
}(window, (function()
{
    ...
    }, function(e, t, r)
    {
        ...
        class g extends i.default
        {
            ...
            [u](e)
            {
                ...
                const {oldContainer : l, newContainer : u} = i, c = this.index(e.source),
            ...
            [c](e)
            {
                if(e.over === e.originalSource || e.over === e.source)
                {
                    return;
                }
                const {source : t, over : r, overContainer : n} = e, o = this.index(t),
    ...
    }, function(e, t, r)
    {
        ...
        class y
        {
            ...
            [h](e)
            {
                ...
                if(this.options.handle && r && !(0, s.closest)(r, this.options.handle))
                {
                    return void t.cancel();
                }
                if(this.originalSource = (0, s.closest)(r, this.options.draggable), this.sourceContainer = n, !this.originalSource)
                {
                    return void t.cancel();
                }
    ...
    }, function(e, t, r)
    {
        ...
        class p extends i.default
        {
            ...
            [c](e)
            {
                ...
                if(this.currentContainer = (0, o.closest)(e.target, this.containers), !this.currentContainer)
                {
                    return;
                }
            ...
            [l](e)
            {
                if(e.target && (e.target.form || e.target.contenteditable))
                {
                    return;
                }
    ...
    }, function(e, t, r)
    {
        ...
        class f extends i.default
        {
            ...
            [l](e)
            {
                ...
                const {distance : r = 0} = this.options, {delay : n} = this, {
                    pageX : s,
                    pageY : i,
                } = (0, o.touchCoords)(e);
                Object.assign(this, {
            ...
            [u](e)
            {
                if(clearTimeout(this.tapTimeout), g = !1, document.removeEventListener("touchend", this[u]), document.removeEventListener("touchcancel", this[u]), document.removeEventListener("touchmove", this[h]), this.currentContainer && this.currentContainer.removeEventListener("contextmenu", p), !this.dragging)
                {
                    return;
                }
    ...
    }, function(e, t, r)
    {
        ...
        class f extends i.default
        {
            ...
            [g](e)
            {
                ...
                if(Object.assign(this, {pageX : t, pageY : r}), !this.currentContainer)
                {
                    return;
                }
            ...
            [d](e)
            {
                if(clearTimeout(this.mouseDownTimeout), 0 !== e.button)
                {
                    return;
                }
                if(document.removeEventListener("mouseup", this[d]), document.removeEventListener("dragstart", p), document.removeEventListener("mousemove", this[g]), !this.dragging)
                {
                    return;
                }
    ...
    }, function(e, t, r)
    {
        ...
        Object.defineProperty(t, "__esModule", {value : !0}), t.default = function(e, t)
        {
            ...
            do
            {
                if(d = d.correspondingUseElement || d.correspondingElement || d, (h = d) ? a ? n.call(h, r) : u ? [...s].includes(h) : c ? i === h : l && o(h) : h)
                {
                    return d;
                }
                d = d.parentNode;
        ...
        class m extends i.default
        {
            ...
            [c](e)
            {
                ...
                if(this.options.thresholdX || this.options.thresholdY)
                {
                    ...
                    if(Math.abs(e - o.clientX) < this.options.thresholdX ? s = !1 : this.lastMirrorMovedClient.x = o.clientX, Math.abs(t - o.clientY) < this.options.thresholdY ? i = !1 : this.lastMirrorMovedClient.y = o.clientY, !s && !i)
                    {
                        return;
                    }
                }
            ...
            [d](e)
            {
                if("ontouchstart" in window && document.removeEventListener("scroll", this[f], !0), this.initialScrollOffset = {
                    x : 0,
                    y : 0,
                }, this.scrollOffset = {x : 0, y : 0}, !this.mirror)
                {
                    return;
                }
...
}(window, (function()
{
    ...
    }, function(e, t, r)
    {
        ...
        e.exports = function(e, t, r, v, m, b, y)
        {
            ...
            {
                return D.call(this);
            }), n && !y || !h && !w && P[d] || i(P, d, x), a[t] = x, a[M] = p, m)
            {
                if(E = {
                    values : C ? x : _(f),
                    keys : b ? x : _(g),
    ...
    }, function(e, t, r)
    {
        ...
        (t = e.exports = function(e, t, r, d, h)
        {
            ...
            if(s(m))
            {
                for(g = a(e.length); g > y; y++) if((v = t ? b(i(f = e[y])[0], f[1]) : b(e[y])) === u || v === c)
                {
                    return v;
                }
            }
            ...
            {
                for(p = m.call(e); !(f = p.next()).done;) if((v = o(p, b, f.value, t)) === u || v === c)
                {
                    return v;
                }
            }
        ...
        var n, o, s, i, a = r(21), l = r(1), u = r(27), c = r(30), d = r(15), h = r(8), g = r(26), f = r(140),
            ...
            }, T = function(e)
            {
                m.call(l, (function()
                {
                    ...
                    })), e._h = x || A(e) ? 2 : 1), e._a = void 0, s && t.e)
                    {
                        throw t.v;
                    }
                }));
    ...
    }, function(e, t, r)
    {
        ...
        e.exports = function(e)
        {
            ...
            if(r)
            {
                for(var i, a = r(e), l = s.f, u = 0; a.length > u;) l.call(e, i = a[u++]) && t.push(i);
            }
            return t;
        };
    }, function(e, t, r)
        ...
        }), Y && i(i.S + i.F * (!q || u((function()
        {
            ...
            stringify : function(e)
            {
                ...
                if(r = t = n[1], (y(t) || void 0 !== e) && !U(e))
                {
                    ...
                    {
                        if("function" == typeof r && (t = r.call(this, e, t)), !U(t))
                        {
                            return t;
                        }
                    }), n[1] = t, X.apply(Y, n);
