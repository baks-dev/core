...
function readGeoMaps($idCity, $idCityHelp)
{
    ...
    $profileCity = document.getElementById($idCity);
            ...
            myGeocoder.then(
                function(res)
                {
                    ...
                    if($res.name !== $city)
                    {
                        ...
                        $helpCountry.innerText = yamapsLang[$locale].errorCity + " \"" + $res.text + "\"";
                    }
                    else
                    {
...
function ymapsInit(e)
{
    ...
    }, t.count = function(e)
    {
        ...
        :
            ...
            already;
            provided.
            ");o=e(r)},t.exports=i,t.exports}(),t.vow=t.ns.vow=function(e){var t,r={exports:{}};r.exports;return function(e){var n,o=function(){var n=[],t=function(e){return n.push(e),1===n.length},r=function(){var e=n,t=0,r=n.length;for(n=[];t<r;)e[t++]()};if(";

            function

            "==typeof setImmediate)return function(e){t(e)&&setImmediate(r)};if(";
            object;
            "==typeof process&&process.nextTick)return function(e){t(e)&&process.nextTick(r)};var o=e.MutationObserver||e.WebKitMutationObserver;if(o){var i=1,s=document.createTextNode(";
            ");return new o(r).observe(s,{characterData:!0}),function(e){t(e)&&(s.data=i*=-1)}}if(e.postMessage){var a=!0;if(e.attachEvent){var u=function(){a=!1};e.attachEvent(";
            onmessage;
            ",u),e.postMessage(";
            __checkAsync;
            "," * "),e.detachEvent(";
