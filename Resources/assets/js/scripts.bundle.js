...
var KTFeedback = function(e)
{
    ...
    r(), t.show = function()
    {
        return function()
        {
            ...
            {
                return "popup" === t.options.type && a(), KTEventHandler.trigger(t.element, "kt.feedback.shown", t), t;
            }
        }();
    }, t.hide = function()
    {
        return function()
        {
            ...
            {
                return "popup" === t.options.type && s(), t.shown = !1, KTEventHandler.trigger(t.element, "kt.feedback.hidden", t), t;
            }
        }();
    }, t.isShown = function()
    {
...
}, KTMenu.initGlobalHandlers = function()
{
    document.addEventListener("click", (function(e)
    {
        ...
        if(r && r.length > 0)
        {
            for(var o = 0, a = r.length; o < a; o++) if(t = r[o], (i = KTMenu.getInstance(t)) && "dropdown" === i.getItemSubType(t))
            {
    ...
    if(e)
    {
        ...
        var i = {minLength : 2, keypress : !0, enter : !0, layout : "menu", responsive : null, showOnFocus : !0},
            r = function()
            {
                ...
                n.options =
                    KTUtil.deepExtend({}, i, t),
                    n.processing = !1, n.element = e,
            ...
            }, m = function()
            {
                ...
                {
                    var e = T();
                    n.contentElement && "on" === e && !1 === n.contentElement.contains(n.formElement) ? (n.contentElement.prepend(n.formElement), n.formElement.classList.remove("d-none")) : "off" === e && !0 === n.contentElement.contains(n.formElement) && (n.element.prepend(n.formElement), n.formElement.classList.add("d-none"));
                }
            }, f = function()
            {
    ...
    if(null != e)
    {
        ...
        }, r = function()
        {
            ...
            })), KTUtil.on(n.element, "[data-kt-stepper-action=\"step\"]", "click", (function(e)
            {
                ...
                {
                    for(var t = 0, i = n.steps.length; t < i; t++) if(n.steps[t] === this)
                    {
                        return n.clickedStepIndex = t + 1, void KTEventHandler.trigger(n.element, "kt.stepper.click", n);
                    }
                }
...
var KTToggle = function(e, t)
{
    ...
    if(e)
    {
        ...
        }, l = function()
        {
            if(!0 !== u())
            {
                return KTEventHandler.trigger(n.element, "kt.toggle.enable", n), n.target.setAttribute(n.attribute, "on"), n.state.length > 0 && n.element.classList.add(n.state), void 0 !== KTCookie && !0 === n.options.saveState && KTCookie.set(n.attribute, "on"), KTEventHandler.trigger(n.element, "kt.toggle.enabled", n), n;
            }
        }, s = function()
        {
            if(!1 !== u())
            {
                return KTEventHandler.trigger(n.element, "kt.toggle.disable", n), n.target.removeAttribute(n.attribute), n.state.length > 0 && n.element.classList.remove(n.state), void 0 !== KTCookie && !0 === n.options.saveState && KTCookie.remove(n.attribute), KTEventHandler.trigger(n.element, "kt.toggle.disabled", n), n;
            }
        }, u = function()
        {
...
var KTUtil = function()
{
    ...
    return {
        ...
        }, getURLParam : function(e)
        {
            ...
            for(t = 0; t < i.length; t++) if((n = i[t].split("="))[0] == e)
            {
                return unescape(n[1]);
            }
            return null;
        ...
        {
            e = e || {};
            for(var t = 1; t < arguments.length; t++) if(arguments[t])
            {
        ...
        }, hasClasses : function(e, t)
        {
            if(e)
            {
                for(var n = t.split(" "), i = 0; i < n.length; i++) if(0 == KTUtil.hasClass(e, KTUtil.trim(n[i])))
                {
                    return !1;
                }
                return !0;
        ...
        {
            for(var t = e.parentNode.children, n = 0; n < t.length; n++) if(t[n] == e)
            {
                return n;
            }
        }, trim : function(e)
        ...
        }, offset : function(e)
        {
            ...
            if(e)
            {
                return e.getClientRects().length ? (t = e.getBoundingClientRect(), n = e.ownerDocument.defaultView, {
        ...
        }, actualCss : function(e, t, n)
        {
            ...
            {
                return e.getAttribute("kt-hidden-" + t) && !1 !== n ? parseFloat(e.getAttribute("kt-hidden-" + t)) : (r = e.style.cssText, e.style.cssText = "position: absolute; visibility: hidden; display: block;", "width" == t ? i = e.offsetWidth : "height" == t && (i = e.offsetHeight), e.style.cssText = r, e.setAttribute("kt-hidden-" + t, i), parseFloat(i));
            }
        ...
        }, css : function(e, t, n, i)
        {
            if(e)
            {
                ...
                else
                {
                    ...
                    {
                        return t = t.replace(/([A-Z])/g, "-$1").toLowerCase(), r.getComputedStyle(e, null).getPropertyValue(t);
                    }
                    if(e.currentStyle)
                    {
